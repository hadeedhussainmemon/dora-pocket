...
export function TailButton() {
    const handlePull = () => {
        ...
        const interval: any = setInterval(function () {
            ...
            // Dorayaki Colors (Gold/Brown) + Gadget Colors (Blue/Pink/Green)
            confetti({
                ...defaults,
                particleCount,
                origin: { x: randomInRange(0.1, 0.9), y: Math.random() * 0.2 },
                colors: ['#FFD700', '#8D6E63', '#0096D7', '#E91E63', '#4CAF50'],
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 group">
            ...
            <motion.button
                ...
                className="relative w-16 h-16 pointer-events-auto focus:outline-none flex items-center justify-center cursor-pointer active:cursor-grabbing"
            >
                {/* CSS 3D Tail */}
