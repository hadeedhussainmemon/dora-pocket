...
export function TaskItem({ task, onToggle }: TaskItemProps) {
    return (
        ...
        >
            <div className={`relative flex items-center justify-center w-8 h-8 rounded-lg mr-4 shadow-inner transition-colors duration-300 ${task.completed ? "bg-green-500" : "bg-gray-100"}`}>
                <motion.div
                    initial={false}
